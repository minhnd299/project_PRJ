            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Create Invoice</h1><hr>
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="col-md-12">
                                ...
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <div class="col-md-12">
                                            <form class="row g-3 needs-validation" action="invoice?action=create" method="post" >
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select class="form-select" id="ReaderID" required name="ReaderID">
                                                        ...
                                                        <c:forEach items="${listReader}" var="rd">
                                                            <option value="${rd.getReaderID()}">${rd.getReaderID()}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="BorrowDate" class="form-label">Borrow Date</label>
                                                    <input type="date" class="form-control" id="BorrowDate" value="" name="BorrowDate">
                                                </div>
                ...
                <script>
                    ...
                    document.getElementById('InvoiceID').value = 'IN' + Date.now();
